...
public class BiomeDecorator
{
    ...
    /** The Blueberry Bush Generation! */
    protected WorldGenerator blueberryBushGen;
    ...
    /** Amount of blueberry bushes per chunk */
    protected int blueberryBushesPerChunk;
    ...
    public BiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        this.blueberryBushGen = new WorldGenFlowers(Block.blueberryBush.blockID);
        ...
        this.blueberryBushesPerChunk = 0;
    ...
    protected void decorate()
    {
        ...
        for (var2 = 0; var2 < this.blueberryBushesPerChunk; ++var2)
        {
            var3 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            var4 = this.randomGenerator.nextInt(128);
            var7 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            (new WorldGenBush(Block.blueberryBush.blockID)).generate(this.currentWorld, this.randomGenerator, var3, var4, var7);
        }
